        ...
        <Card className="bg-white/[0.03] border-white/[0.06] backdrop-blur space-y-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Zero fabricated certainty on unsafe inputs.</p>
            </div>
          </div>
          <p className="text-xs text-gray-300 leading-relaxed">
            Unlike traditional black-box classifiers that force a prediction on every input, QuantumHealth AI enforces automated model abstention (HTTP 200 with <code className="text-indigo-300 font-mono">status: "abstained"</code> and zero risk score returned) when:
          </p>
        ...
        <Card className="bg-white/[0.03] border-white/[0.06] backdrop-blur space-y-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Strict 60% Train / 20% Val / 20% Test splits.</p>
            </div>
          </div>
          <p className="text-xs text-gray-300 leading-relaxed">
        ...
        <Card className="bg-white/[0.03] border-white/[0.06] backdrop-blur space-y-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">PennyLane statevector simulator (default.qubit).</p>
            </div>
          </div>
          <p className="text-xs text-gray-300 leading-relaxed">
            All quantum circuits in QuantumHealth AI are executed in <strong>Simulation Mode</strong> using PennyLane's <code className="text-purple-300 font-mono">default.qubit</code> simulator on classical CPUs.
          </p>
        ...
        <Card className="bg-white/[0.03] border-white/[0.06] backdrop-blur space-y-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Explaining model sensitivity, not pathophysiology.</p>
            </div>
          </div>
          <p className="text-xs text-gray-300 leading-relaxed">
      ...
      <Card className="bg-white/[0.03] border-white/[0.06] backdrop-blur space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-white/[0.06]">
          <h3 className="text-lg font-bold text-white flex items-center gap-2">
            <FileText size={18} className="text-indigo-400" /> Biomedical Dataset Provenance
          </h3>
          <span className="text-xs font-mono text-gray-400">Public Repositories & Demonstration Modules</span>
        </div>
          ...
          <table className="w-full text-xs text-left font-mono">
            ...
            <tbody className="divide-y divide-white/[0.06]">
              <tr className="hover:bg-white/[0.02]">
                ...
                <td className="px-4 py-3.5 text-gray-300">Dryad / BMJ Open (Chen et al., 2018; DOI: 10.1136/bmjopen-2018-021768)</td>
                <td className="px-4 py-3.5 text-emerald-400 font-bold">211,833 rows</td>
                <td className="px-4 py-3.5 text-gray-400">Multi-center grouped hospital split</td>
              ...
              <tr className="hover:bg-white/[0.02]">
                ...
                <td className="px-4 py-3.5 text-gray-300">UCI Cleveland Clinic Foundation (Detrano et al., 1989; DOI: 10.24432/C52P4X)</td>
                <td className="px-4 py-3.5 text-indigo-300">303 rows</td>
                <td className="px-4 py-3.5 text-gray-400">Stratified 5-Fold Cross-Validation</td>
              ...
              <tr className="hover:bg-white/[0.02]">
                ...
                <td className="px-4 py-3.5 text-gray-300">UCI Wisconsin Diagnostic (WDBC; Street et al., 1993; DOI: 10.24432/C5DW2B)</td>
                <td className="px-4 py-3.5 text-indigo-300">569 rows</td>
                <td className="px-4 py-3.5 text-gray-400">Stratified 5-Fold Cross-Validation</td>
              ...
              <tr className="hover:bg-white/[0.02]">
                ...
                <td className="px-4 py-3.5 text-gray-300">Apollo Hospitals Tamil Nadu / UCI (Rubini et al., 2015; DOI: 10.24432/C5G020)</td>
                <td className="px-4 py-3.5 text-indigo-300">400 rows</td>
                <td className="px-4 py-3.5 text-gray-400">Stratified 5-Fold Cross-Validation</td>
        ...
        <div className="pt-4 border-t border-white/[0.06] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2 text-emerald-400 font-mono font-semibold">
            ...
            <span>Automated Pytest Suite: 50 / 50 Passing (293.91s execution)</span>
          </div>
